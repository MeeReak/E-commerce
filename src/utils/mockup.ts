...
export const productDescription = {
  ...
  note: "Cras et diam maximus, accumsan sapien et, sollicitudin velit. Nulla blandit eros non turpis lobortis iaculis at ut massa.",
};
...
export const feature = [
  {
    ...
    title: "64% Discount",
    detail: "Save your 64% money with us",
  },
  {
    src: "/svg/leaf.svg",
    title: "100% Organic",
    ...
    comments: [
      {
        ...
        rating: 5,
        date: "1 day ago",
        comment: "The carrots are so sweet and crunchy! My kids love them.",
      },
      {
      ...
      },
      {
        ...
        rating: 3,
        date: "3 days ago",
        comment: "Good quality but a few pieces were smaller than expected.",
      },
      {
    ...
    comments: [
      {
        ...
        rating: 5,
        date: "1 day ago",
        comment: "The broccoli is so fresh and tasty. My family loves it!",
      },
      {
  ...
  },
  {
    ...
    comments: [
      ...
      },
      {
        ...
        rating: 5,
        date: "3 days ago",
        comment: "Exactly what I needed for my stew. Fresh and flavorful.",
      },
    ],
  ...
  },
  {
    ...
    comments: [
      ...
      },
      {
        ...
        rating: 4,
        date: "2 days ago",
        comment: "Perfect for curries and soups. Will definitely repurchase.",
      },
      {
        id: "11725c75-9285-4701-b7c4-e4082393d101",
        name: "Kimlang Pen",
      ...
      },
      {
        ...
        rating: 5,
        date: "3 days ago",
        comment: "High quality! Cooked a roast and it turned out perfectly.",
      },
    ],
  ...
  },
  {
    ...
    comments: [
      ...
      },
      {
        ...
        rating: 4,
        date: "2 days ago",
        comment: "Fresh and delicious, but slightly smaller than expected.",
      },
      {
      ...
      },
      {
        ...
        rating: 5,
        date: "6 days ago",
        comment: "Fresh and flavorful duck! Perfect for our family gathering.",
      },
    ],
...
//   { id: 11, name: 'Georgia' },
//   { id: 12, name: 'India' },
//   { id: 13, name: 'Indonesia' },
//   { id: 14, name: 'Iran' },
//   { id: 15, name: 'Iraq' },
//   { id: 16, name: 'Israel' },
//   { id: 17, name: 'Japan' },
//   { id: 18, name: 'Jordan' },
//   { id: 19, name: 'Kazakhstan' },
//   { id: 20, name: 'Kuwait' },
//   { id: 21, name: 'Kyrgyzstan' },
//   { id: 22, name: 'Laos' },
//   { id: 23, name: 'Lebanon' },
//   { id: 24, name: 'Malaysia' },
//   { id: 25, name: 'Maldives' },
...
//   { id: 27, name: 'Myanmar' },
//   { id: 28, name: 'Nepal' },
//   { id: 29, name: 'North Korea' },
//   { id: 30, name: 'Oman' },
//   { id: 31, name: 'Pakistan' },
//   { id: 32, name: 'Palestine' },
//   { id: 33, name: 'Philippines' },
//   { id: 34, name: 'Qatar' },
//   { id: 35, name: 'Russia' },
//   { id: 36, name: 'Saudi Arabia' },
//   { id: 37, name: 'Singapore' },
//   { id: 38, name: 'South Korea' },
//   { id: 39, name: 'Sri Lanka' },
//   { id: 40, name: 'Syria' },
//   { id: 41, name: 'Tajikistan' },
//   { id: 42, name: 'Thailand' },
//   { id: 43, name: 'Timor-Leste' },
//   { id: 44, name: 'Turkey' },
//   { id: 45, name: 'Turkmenistan' },
//   { id: 46, name: 'United Arab Emirates' },
//   { id: 47, name: 'Uzbekistan' },
//   { id: 48, name: 'Vietnam' },
//   { id: 49, name: 'Yemen' }
// ];
...
export const Province = [
  ...
  { id: 8, name: "Koh Kong" },
  { id: 9, name: "Kratie" },
  { id: 10, name: "Mondulkiri" },
  { id: 11, name: "Phnom Penh" },
  { id: 12, name: "Preah Vihear" },
  { id: 13, name: "Prey Veng" },
  { id: 14, name: "Pursat" },
  { id: 15, name: "Ratanakiri" },
  { id: 16, name: "Siem Reap" },
  { id: 17, name: "Sihanoukville" },
  { id: 18, name: "Stung Treng" },
  { id: 19, name: "Svay Rieng" },
  { id: 20, name: "Takeo" },
  { id: 21, name: "Tboung Khmum" },
